const { reverseLinkedList } = require('../lib/1_reverse_linked_list.js.js');
const { stringify, linkedListIntersection } = require('../lib/2_linked_list_intersection.js.js');
const { LinkedList, hasCycle } = require('../lib/3_linked_list_cycles.js.js');
